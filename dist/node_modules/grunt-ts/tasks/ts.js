define(["require", "exports", "lodash", "path", "fs", "es6-promise", "./modules/utils", "./modules/compile", "./modules/reference", "./modules/amdLoader", "./modules/html2ts", "./modules/templateCache", "./modules/transformers", "../tasks/modules/optionsResolver"], function (require, exports, _, path, fs, es6_promise_1, utils, compileModule, referenceModule, amdLoaderModule, html2tsModule, templateCacheModule, transformers, optionsResolver) {
    'use strict';
